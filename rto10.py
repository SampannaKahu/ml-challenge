...
learner3 = MLPClassifier(hidden_layer_sizes=(100,), verbose=10)

clf = RandomForestClassifier(n_jobs=-1, n_estimators=100, max_depth=13, random_state=42, min_samples_split=6,
                             min_impurity_split=0.05, bootstrap=False)
...
# feature_selector = SelectPercentile(score_func=f_classif, percentile=20)
# feature_selector = SelectFromModel(
#     RandomForestClassifier(n_jobs=-1, n_estimators=100, max_depth=13, random_state=42, min_samples_split=6,
#                            min_impurity_split=0.05, bootstrap=False))
feature_selector = SelectFromModel(estimator=MLPClassifier())
...
# parameter_space = {'learner__max_depth': (10, 11, 12, 13, 14, 15)}
# grid_search = GridSearchCV(final_pipeline, parameter_space, n_jobs=-1, verbose=1, scoring='roc_auc')
# print("Performing grid search...")
# print("pipeline:", [name for name, _ in final_pipeline.steps])
# print("parameters:")
# print(parameter_space)
# t0 = time()
# grid_search.fit(df_train_X.values, df_train_Y)
